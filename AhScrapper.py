...
{Fore.CYAN}                    d s.   d    d                         
                    S  ~O  S    S                         
                    S   `b S    S                    +=====+    
                    S sSSO S sSSS                    |({Fore.RED}1.0{Fore.CYAN})|      
                    S    O S    S                    +=====+     
                    S    O S    S                        
                    P    P P    P                     
{Fore.YELLOW}==============================================================                                            
{Fore.CYAN}  sss.   sSSs. d ss.  d s.   d ss.  d ss.  d sss   d ss.  
d       S      S    b S  ~O  S    b S    b S       S    b 
Y      S       S    P S   `b S    P S    P S       S    P 
  ss.  S       S sS'  S sSSO S sS'  S sS'  S sSSs  S sS'  
     b S       S   S  S    O S      S      S       S   S  
     P  S      S    S S    O S      S      S       S    S 
` ss'    "sss' P    P P    P P      P      P sSSss P    P
{Fore.YELLOW}==============================================================                                            
"""
